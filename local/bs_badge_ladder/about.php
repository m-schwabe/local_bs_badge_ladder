...
$pageparams = array();
admin_externalpage_setup('local_bs_badge_ladder_about', '', $pageparams);
$siteurl = new moodle_url('/local/bs_badge_ladder/about.php', $pageparams);
